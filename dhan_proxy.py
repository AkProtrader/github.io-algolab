...
def yf_quotes():
    """
    Relay Yahoo Finance quote requests — bypasses browser CORS block.
    Usage: GET /quotes?symbols=RELIANCE.NS,TCS.NS
    """
    symbols = request.args.get("symbols", "")
    fields = request.args.get("fields", "regularMarketPrice,regularMarketChangePercent,regularMarketChange,regularMarketPreviousClose,regularMarketDayHigh,regularMarketDayLow,regularMarketVolume,fiftyTwoWeekHigh,fiftyTwoWeekLow")

    try:
        r = requests.get(
            f"https://query1.finance.yahoo.com/v7/finance/quote",
            params={"symbols": symbols, "fields": fields},
            headers={
...
if __name__ == "__main__":
    ...
    print(f"  Market Data   : ✔ Ready (Yahoo Finance relay)")
